;(function () {
      ...
      var audio = document.createElement('audio'),
        ...
        player = {
          ...
          eventSkip: function () {
            ...
            percentPlayed =
              (100 / player.playlist.position.duration) * player.playlist.position.position
  ...
  MusicLoud.directive('seekController', [
    '$rootScope',
    function ($rootScope) {
      return {
  ...
  MusicLoud.directive('trackPosition', [
    '$rootScope',
    function ($rootScope) {
      return {
        link: function (scope, element, attrs) {
  ...
  MusicLoud.directive('volumeController', [
    '$rootScope',
    '$document',
          ...
          var line = element.find('.value-line'),
            ...
            dragEvents = {
              ...
              dragStart: function (event) {
                dragEvents.mouseOffset =
                  element.height() - (event.clientY + $(window).scrollTop() - element.offset().top)
                dragEvents.mousePos = event.clientY
                doc.bind('mousemove', mouseEvents.mousemove).bind('mouseup', mouseEvents.mouseup)
              ...
              dragStop: function () {
                doc
                  .unbind('mousemove', mouseEvents.mousemove)
  ...
  MusicLoud.directive('actionPlay', [
    '$rootScope',
    function ($rootScope) {
      return {
        scope: {
